...
export default function IntroInfo({ title, description }) {
  return (
    <div
      className={`max-w-7xl mx-4 sm:mx-auto my-10 px-6 py-10 md:px-8 md:py-12 bg-gradient-to-r from-purple-100 to-blue-100 rounded-3xl flex flex-col justify-center items-start gap-6 shadow-sm`}
    >
