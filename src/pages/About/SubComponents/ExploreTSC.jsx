  ...
  return (
    <>
      <div className="flex flex-col mb-12">
        ...
        <div className="w-full max-w-3xl mx-auto bg-black px-4 sm:px-8 py-6 sm:py-8 rounded-2xl flex flex-wrap justify-center gap-6 sm:gap-8 md:mx-auto sm:mx-auto">
          {headings.map(hd => (
