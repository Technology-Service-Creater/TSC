  ...
  return (
    <>
      ...
      {/* <div className="flex flex-col lg:flex-row max-w-[1190px] h-auto lg:h-[687px] mx-6 lg:mx-[125px] my-10 lg:my-14">
        ...
        <div
          className="w-full lg:w-1/2 h-[300px] sm:h-[400px] md:h-[450px] lg:h-full bg-cover bg-center"
          style={{ backgroundImage: `url(${image})` }}
        ></div>
      </div> */}

      {/* 
      <div className="flex sm:flex-col md:flex-col lg:flex-row  max-w-[1190px] h-[687px] mx-[125px] my-14">
        <div className="flex flex-col w-1/2 my-auto">
          <div className="flex flex-col max-h-[388px] max-w-[586px]">
            <div className="flex text-neutral-800 text-5xl font-bold font-['Poppins'] leading-[60px] mb-6">
              {heading}
            </div>
        ...
        <div className="flex w-1/2 h-full" style={{ backgroundImage: `url(${image})` }}></div>
      </div> */}
    </>
  );
};
