...
function TestimonialCarousel() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-8 mt-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full justify-center place-items-center">
        {testimonials.map((t, idx) => (
          <div
            key={idx}
            className="bg-[#222] rounded-lg flex flex-col items-center p-6 min-w-[260px] max-w-md w-full shadow-md relative mx-auto"
          >
            <img
              src={t.img}
              alt={t.name}
